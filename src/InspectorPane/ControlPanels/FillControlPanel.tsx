...
const FillControlPanel = ({ selection }: Props) => {
  ...
  const [tickRadialModeSwitch, setTickRadialModeSwitch] = useState(false)
  ...
  const handleRadioGroupSelect = (e: any) => {
    switch (e.target.value) {
      ...
      case "linearGradient":
        ...
        setTickRadialModeSwitch(!tickRadialModeSwitch)
  ...
  return (
    <>
      <Radio.Group value={radioGroupValue} size="small" style={{ marginTop: 16 }}>
        ...
        <Radio.Button value="linearGradient" onClick={handleRadioGroupSelect}>Linear Gradient</Radio.Button>
        <Radio.Button value="radialGradient" onClick={handleRadioGroupSelect}>Radial Gradient</Radio.Button>
      </Radio.Group>
      ...
      <GradientControlPanel selection={selection} tickRadialModeSwitch={tickRadialModeSwitch} />
      }
    </>
  )
