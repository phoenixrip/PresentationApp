...
const Colorpicker = ({ color, onChange, palette }: ColorpickerPropsType) => {
	...
	return (
		<>
			<RgbaStringColorPicker color={internalColor.toRgbString()} onChange={parseColor} />
			{/* <Row>
				<Col span={22}>
					<Input.Group compact>
						<Select value={stringInputMode} onChange={setStringInputMode}>
